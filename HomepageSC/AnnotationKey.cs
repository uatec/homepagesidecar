...
{
    public const string Enable = "homepagesc.neutrino.io/enable";
    ...
    public const string Healthcheck = "homepagesc.neutrino.io/healthCheck";
    public const string AppName = "homepagesc.neutrino.io/appName";
}